...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "لا توجد بيانات متاحة بالجدول",
			 ...
			 *    } );
			 */
			"sInfo": "عرض _START_ الى _END_ من _اصل_ مدخل",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "عرض 0 من 0 الى 0 ادخالات",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(تمت تصفيتها  من اجمالي _MAX_)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "يعرض _MENU_ إدخالات",
...
$.extend( true, DataTable.defaults, {
	dom:
		...
		"<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 pagination-flex'p>>",
	renderer: 'bootstrap'
} );
